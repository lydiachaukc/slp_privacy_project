...
anoni_pool= # The stem with which all folders to be used for the pool start with 
...
echo "anon_xvec_out_dir: ${anon_xvec_out_dir}"
...
if [ $stage -le 1 ]; then
  ...
  local/anon/make_pseudospeaker2.sh --rand-level ${pseudo_xvec_rand_level} \
