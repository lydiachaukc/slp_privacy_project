...
data_train_tts=$libritts_train_clean_360            # training set 
data_train_tts_out=${libritts_train_clean_360}_tts  # directory name to save the prepared data for TTS models
